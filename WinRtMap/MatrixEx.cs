...
namespace WinRtMap
{
	public static class MatrixEx
	{
		...
		public static Matrix Translate(this Matrix matrix, Point offset)
		{
		...
		public static Matrix RotateAt(this Matrix matrix, double angle, Point center)
		{
			return RotateAt(matrix, angle, center.X, center.Y);
		}
